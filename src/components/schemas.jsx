...
export const personalInfoSchema = z.object({
    ...
    rif: z.string().min(1, 'El RIF es obligatorio').regex(/^[JVGPE][0-9]{8}[-][0-9]$/, 'El RIF debe ser válido. EJ: V12345678-9'),
...
export const personalInfoPymeSchema = z.object({
    ...
    business_rif: z.string().min(1, 'El RIF es obligatorio').regex(/^[JVGPE][0-9]{8}[-][0-9]$/, 'El RIF debe ser válido. EJ: J12345678-9'),
    ...
    legal_rif: z.string().min(1, 'El RIF es obligatorio').regex(/^[JVGPE][0-9]{8}[-][0-9]$/, 'El RIF debe ser válido. EJ: V12345678-9'),
